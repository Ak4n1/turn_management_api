...
/**
 * Respuesta paginada para listado de usuarios (admin).
 */
public class AdminUsersPageResponse {
    ...
    public AdminUsersPageResponse(List<UserResponse> content, long totalElements, int totalPages, int page, int size) {
