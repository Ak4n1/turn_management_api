...
@Component
public class AppointmentCreatedTemplate implements EmailTemplate {
    ...
    public AppointmentCreatedTemplate() {
    }

    public AppointmentCreatedTemplate setUser(User user) {
        this.user = user;
        return this;
    }

    public AppointmentCreatedTemplate setAppointment(Appointment appointment) {
    ...
    public String getSubject() {
        return "Turno creado - " + appointment.getAppointmentDate().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + " " + appointment.getStartTime();
    }
        ...
        return String.format("""
            ...
            <head>
                ...
                <style>
                    ...
                    .appointment-info { background-color: white; padding: 15px; margin: 15px 0; border-left: 4px solid #2196F3; }
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        <p>Hola %s,</p>
                        <p>Tu turno ha sido creado exitosamente. Aquí están los detalles:</p>
                        ...
                        <div class="appointment-info">
                            ...
                            <div class="info-row">
                                ...
                                <span class="info-value">Creado (pendiente de confirmación)</span>
                            </div>
                        </div>
                        
                        <div class="warning">
                            <p><strong>⚠️ Importante:</strong></p>
                            <p>Este turno está en estado <strong>CREADO</strong> y requiere confirmación. 
                            Por favor, confirma tu turno lo antes posible para asegurar tu reserva.</p>
                            <p>El turno expirará automáticamente si no se confirma a tiempo.</p>
                        </div>
